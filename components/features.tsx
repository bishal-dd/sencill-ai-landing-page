...
const features = [
  {
    ...
    description:
      "Choose from dozens of professionally designed templates tailored for travel agencies, hotels, and businesses.",
  },
  {
    icon: Rocket,
  ...
  },
  {
    ...
    description: "Build professional websites without writing a single line of code. Perfect for non-technical users.",
  },
  {
    icon: Globe,
    title: "SEO Optimized",
    description: "All websites are built with SEO best practices, helping you rank higher in search results.",
  },
  {
    icon: Shield,
    title: "Secure & Reliable",
    description: "Enterprise-grade security and 99.9% uptime guarantee. Your website is always safe and accessible.",
  },
]
